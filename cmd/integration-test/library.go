...
import (
	...
	"github.com/t101804/httpr/runner"
)
...
func (h *httpxLibrary) Execute() error {
	...
	// httpx removes default ports for simplicity Ref: https://pkg.go.dev/github.com/t101804/httpr/common/stringz#RemoveURLDefaultPort
